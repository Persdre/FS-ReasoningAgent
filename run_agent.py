...
def get_parser():
    ...
    parser.add_argument("--model", type=str, default='gpt-3.5-turbo', help="[gpt-3.5-turbo, gpt-4o, o1-preview, o1-mini]")
    parser.add_argument("--to_print", type=int, default=1, help="Print debug info")

    parser.add_argument("--starting_date", type=str, default='2024-01-31', help="The starting date for the environment")
