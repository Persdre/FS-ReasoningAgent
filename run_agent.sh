# btc
## o1-mini bull
python -u run_agent.py --model o1-mini --dataset btc --starting_date 2023-10-01 --ending_date 2023-12-01 &>updated_reasoning/btc-bull-o1-mini-reasoning.out 2>&1
...
## 4o bull
python -u run_agent.py --model gpt-4o --dataset btc --starting_date 2023-10-01 --ending_date 2023-12-01 &>updated_reasoning/btc-bull-4o-reasoning.out 2>&1
## 4o bear
...
## 3.5 bull
python -u run_agent.py --model gpt-3.5-turbo --dataset btc --starting_date 2023-10-01 --ending_date 2023-12-01 &>updated_reasoning/btc-bull-3.5-reasoning.out 2>&1
## 3.5 bear
